...
| Best observed A100 operability | Qwen 2.5 Coder 7B safe profile | Completed training and reached 100/100 generation success in the observed run. |
...
| `agentic-devstral-24b` | Larger coding/agentic model, completed full 1,985-sample training, exported multiple GGUF quantizations. | Much slower benchmark throughput, lower observed success rate, heavier export/runtime path. | Useful high-capability candidate, but not the observed default winner. |
